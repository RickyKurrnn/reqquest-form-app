            ...
            <form action="{{ route('form.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="document_number" class="form-control"
                            placeholder="Auto-number or custom">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="application_name" id="application_name_input" class="form-control"
                            placeholder="Enter Application Name" required value="{{ old('application_name') }}">
